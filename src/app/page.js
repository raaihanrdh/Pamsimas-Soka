...
const LandingPage = () => {
  return (
    <div className="min-h-screen  bg-gradient-to-br from-teal-400 via-teal-500 to-teal-600 flex flex-col items-center justify-center text-white relative">
      {/* Header */}
      <header className="absolute top-0 left-0 w-full flex justify-between items-center p-6">
        ...
        <a
          href="/login"
          className="flex items-center gap-2 py-2 px-4 bg-white text-teal-500 rounded-full shadow-lg hover:teal-600 hover:text-white transition duration-300"
        >
          <FiLogIn />
          Sign In
        </a>
      ...
      <div className="text-center mt-20 px-6">
        <div className="bg-teal-400 p-8 rounded-xl shadow-2xl max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <a
              href="/tagihanwarga"
              className="flex items-center justify-between px-6 py-4 rounded-lg bg-white text-teal-600 shadow-md hover:bg-teal-300 hover:text-teal-800 transition duration-300"
            >
              <div className="flex items-center">
                <FiFileText className="text-2xl mr-4" />
                <span className="font-semibold">Lihat Tagihan</span>
              </div>
              <span className="text-teal-600 group-hover:text-teal-800">→</span>
            </a>
            <a
              href="/aduanpelanggan"
              className="flex items-center justify-between px-6 py-4 rounded-lg bg-white text-teal-600 shadow-md hover:bg-teal-300 hover:text-teal-800 transition duration-300"
