    ...
    <div className="min-h-screen p-5 ">
      <div className="flex">
        ...
        <div className="flex-">
          {countTagihan == 0 && (
            <button
              className=" bg-teal-500 px-3 py-2 rounded-lg text-white"
        ...
        <div className="flex space-x-2">
          ...
          {user.permissions.tagihan.read === 1 && (
            <button
              ...
              className="flex items-center bg-teal-500 px-4 py-2 rounded-lg text-white hover:bg-teal-600"
            >
      ...
      {activeTab === "tab1" && (
        <div className="bg-white shadow-lg p-5">
          <div className="flex flex-wrap md:flex-nowrap overflow-auto gap-2 mb-5">
            ...
            ${
              rw === rw._id ? "bg-teal-500 text-white" : "bg-gray-200"
            } hover:bg-teal-400 text-xs md:text-sm`}
                  >
                    {rtRwText}
                  </button>
                );
              ...
              <tbody>
                {filteredData.map((tagihan, index) => (
                  <tr
                    ...
                    className={`transition duration-300 ease-in-out hover:bg-teal-100 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center border-b border-gray-300">
                      <button
                        ...
                        className="bg-teal-500 hover:bg-teal-600 text-white py-2 px-4 rounded-lg transition duration-200 ease-in-out"
                      >
                        Edit
                      </button>
                    </td>
              ...
              >
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-teal-500 text-white  py-2 px-6 mt-2 rounded-full"
                  >
                    Edit
                  </button>
                </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-between mb-10 items-center space-y-4 sm:space-y-0 ">
            ...
            <div className="flex items-center space-x-2 ">
              ...
              <span className="px-3 py-2 bg-teal-500 text-white rounded-lg text-xs sm:text-sm">
