        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          {user.permissions.akun.create === 1 && (
            <button
              ...
              className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-6 py-3 rounded-xl shadow-lg hover:bg-gradient-to-r hover:from-teal-600 hover:to-teal-700 transition-all ease-in-out duration-300"
            >
              + Tambah Akun
            </button>
          )}
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl w-96">
            ...
            <form onSubmit={handleAddAccount} className="space-y-5">
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  className="bg-teal-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-teal-700 transition-all ease-in-out duration-200"
                >
                  Simpan
                </button>
              </div>
