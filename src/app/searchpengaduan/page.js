...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-400 via-teal-500 to-teal-600 px-6 py-8">
          ...
          <div className="flex flex-col sm:w-1/2 space-y-2">
            ...
            <div className="flex w-full">
              ...
              <button
                ...
                className="bg-teal-400 hover:bg-teal-500 text-white py-3 px-6 rounded-r-lg"
              >
                Cari
              </button>
            </div>
